...
public class NamespaceChatLauncher {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        server.addNamespace("/chat1").addEventListener("message", ChatObject.class, messageHandlerService);
        server.addNamespace("/chat2").addEventListener("message", ChatObject.class, messageHandlerService);
